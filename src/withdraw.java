...
public class withdraw extends javax.swing.JFrame {
    ...
    String an;
    String pinn;
    withdraw(String accNum, String pin) {
        initComponents();
        this.an = accNum;
        this.pinn = pin;
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            pst.setString(1, this.an);
            pst.setString(2, this.pinn);
            ResultSet rs = pst.executeQuery();
            
            if(rs.next()){
                String b20="20000";
                String sql1 = "UPDATE user SET balance = balance - ? WHERE accountNumber = ?";
                PreparedStatement pst1 = (PreparedStatement) con.prepareStatement(sql1);
                pst1.setString(1, b20);
                pst1.setString(2, this.an);
